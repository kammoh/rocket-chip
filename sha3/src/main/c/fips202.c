...
void sha3_512_rocc(unsigned char *output, const unsigned char *input, unsigned long long inlen)
{
  sha3_absorb_full(SHA3_512_RATE, input, inlen, 0x06);

  sha3_squeeze(output, 1 * SHA3_512_RATE);
}